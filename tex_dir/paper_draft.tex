...
% Andy
\subsection{Mixture Models}[htbp]
\begin{figure}
    \centering
...
\par While the previous figure demonstrates American temperature trends, SARIMAX models can find relationships between temperature, CO$_2$ levels, and seaice levels. The figure 
